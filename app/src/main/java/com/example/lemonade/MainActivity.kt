...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        //done  TODO: When the image is clicked in the SELECT state, the state should become SQUEEZE
        //  - The lemonSize variable needs to be set using the 'pick()' method in the LemonTree class
        //done   - The squeezeCount should be 0 since we haven't squeezed any lemons just yet.

        // done TODO: When the image is clicked in the SQUEEZE state the squeezeCount needs to be
        ...
        // done TODO: When the image is clicked in the DRINK state the state should become RESTART

        //done TODO: When the image is clicked in the RESTART state the state should become SELECT
